...
$query = "INSERT INTO `patrols` (`id`, `patrol_name`, `member1`, `member2`, `member3`, `member4`, `member5`, `member6`, `member7`, `member8`, `patrol_leader`, `as_patrol_leader`) VALUES (NULL, '".$patrol_name."', '".$member1."', '".$member2."', '".$member3."', '".$member4."', '".$member5."', '".$member6."', '".$member7."', '".$member8."', '".$patrol_leader."', '".$as_patrol_leader."')";
